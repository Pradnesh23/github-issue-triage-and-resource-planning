...
- **MLOps & Experimentation**: MLflow, Optuna
...
├── best_model_bert_3class/       # Pre-trained DistilBERT model
│   ├── config.json
│   ├── model.safetensors
│   ├── numeric_scaler.joblib
│   ├── xgboost_stacking_model.joblib
│   └── tokenizer files
├── notebooks/                    # Jupyter notebooks
│   └── github-issue-predictor.ipynb  # EDA & training examples
├── src/                          # Core modules
...
├── data/                         # Data directory (git-ignored for large files)
...
├── start_test_server.py          # Local testing server
